...
addNew(0, 0.95, [ [1, 0.1], [0.9, 0.3], [0.7, 0.6], [0.2, 0.8], [0, 1] ])
addNew(0, 0.75, [ [1, 0.1], [0.9, 0.3], [0.7, 0.6], [0.2, 0.8], [0, 1] ])
addNew(0, 0.85, [ [1, 0.1], [0.9, 0.3], [0.7, 0.6], [0.2, 0.8], [0, 1] ])
addNew(0, 0.5,  [ [1, 0.1], [0.9, 0.3], [0.7, 0.6], [0.2, 0.8], [0, 1] ])
addNew(0, 0.75, [ [1, 0.1], [0.9, 0.3], [0.7, 0.6], [0.2, 0.8], [0, 1] ])
addNew(0, 0.66, [ [1, 0.1], [0.9, 0.3], [0.7, 0.6], [0.2, 0.8], [0, 1] ])
